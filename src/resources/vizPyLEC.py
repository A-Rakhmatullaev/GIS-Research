...
all_points_files = glob.glob(os.path.join(dir_path, 'nuclear', 'output', 'lec', 'all_points_result.json', 'part-*'))
lec_files = glob.glob(os.path.join(dir_path, 'nuclear', 'output', 'lec', 'lec_result.json', 'part-*'))
